...
from game_app.app.bot import AI
from game_app.app.deepAI import probability_win
from game_app.app.setting import BB, SB, show_game
from game_app.app.utils import custom_argmax, get_content
        ...
        for player in player_list:
            ...
            if not player.decision and player.live:
                ...
                if player.kind == 'human':
                    ...
                    if dict_options['raise']:
                        ...
                        async_to_sync(channel_layer.group_send)(
                            f'{player_id}', {
                                'type': 'player_option',
                                'message': [dict_options['check'], emit_call_value, min_raise, max_raise]})
                        ...
                        async_to_sync(channel_layer.group_send)(
                            f'{player_id}', {
                                'type': 'player_option',
                                'message': [dict_options['check'], emit_call_value, False, False]})
                    ...
                    model = load_model('game_app/models/model_20002epoch-1688915279.303047.h5')
                ...
                async_to_sync(channel_layer.group_send)(
                    f'{player_id}', {
                        'type': 'update_bet',
                        'message': [player.name, player.bet_auction]})
                ...
                async_to_sync(channel_layer.group_send)(
                    f'{player_id}', {
                        'type': 'update_pot',
                        'message': [sum([player.input_stack for player in player_list])]})
                ...
                async_to_sync(channel_layer.group_send)(
                    f'{player_id}', {
                        ...
                        'message': player.name + ' ' + text_decision})
