...
function updateOpponentInfo() {
    ...
    switch (selectedOpponent) {
        case "bot":
            ...
            opponentDescription.textContent = "A poker bot driven by pure math, logic, and probability.";
        ...
        case "ai":
            ...
            opponentDescription.textContent = "An AI bot powered by deep neural networks and reinforcement learning.";
